...
/**
 * /CON - Set Constitution stat
 * UPDATED: Uses popup notifications instead of chat messages
 */
public class CONCommand extends AbstractPlayerCommand {
    ...
    public CONCommand(GridMoveManager playerManager, RoleManager roleManager, EncounterManager encounterManager) {
        super("CON", "Set Constitution stat");
        this.playerManager = playerManager;
        this.roleManager = roleManager;
        this.encounterManager = encounterManager;
        this.valueArg = this.withRequiredArg("value", "Constitution value (0-30)", ArgTypes.INTEGER);
    }
    ...
    protected void execute(@Nonnull CommandContext context,
        ...
        if (roleManager.isGM(playerRef)) {
            ...
            monster.stats.constitution = value;

            Message primary = Message.raw(monster.getDisplayName() + " - Constitution").color("#FF8C00");
            ...
            state.stats.constitution = value;

            Message primary = Message.raw("Constitution").color("#FF8C00");
            Message secondary = Message.raw(CharacterStats.formatStatWithModifier(value)).color("#FFFFFF");
            ItemWithAllMetadata icon = new ItemStack("Ingredient_Crystal_Yellow", 1).toPacket();
