 ...
 */
public class DEXCommand extends AbstractPlayerCommand {
    private final GridMoveManager playerManager;
    private final RoleManager roleManager;
    private final EncounterManager encounterManager;
    private final RequiredArg<Integer> valueArg;

    public DEXCommand(GridMoveManager playerManager, RoleManager roleManager, EncounterManager encounterManager) {
        super("DEX", "Set Dexterity stat");
        this.playerManager = playerManager;
        this.roleManager = roleManager;
        this.encounterManager = encounterManager;
        this.valueArg = this.withRequiredArg("value", "Dexterity value (0-30)", ArgTypes.INTEGER);
    }
    ...
    protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store,
        ...
        if (roleManager.isGM(playerRef)) {
            ...
            monster.stats.dexterity = value;

            Message primary = Message.raw(monster.getDisplayName() + " - Dexterity").color("#00FF00");
            ...
            state.stats.dexterity = value;

            Message primary = Message.raw("Dexterity").color("#00FF00");
            Message secondary = Message.raw(CharacterStats.formatStatWithModifier(value)).color("#FFFFFF");
            ItemWithAllMetadata icon = new ItemStack("Ingredient_Crystal_Green", 1).toPacket();
