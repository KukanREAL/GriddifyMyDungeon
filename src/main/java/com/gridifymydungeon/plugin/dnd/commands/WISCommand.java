 ...
 */
public class WISCommand extends AbstractPlayerCommand {
    private final GridMoveManager playerManager;
    private final RoleManager roleManager;
    private final EncounterManager encounterManager;
    private final RequiredArg<Integer> valueArg;

    public WISCommand(GridMoveManager playerManager, RoleManager roleManager, EncounterManager encounterManager) {
        super("WIS", "Set Wisdom stat");
        this.playerManager = playerManager;
        this.roleManager = roleManager;
        this.encounterManager = encounterManager;
        this.valueArg = this.withRequiredArg("value", "Wisdom value (0-30)", ArgTypes.INTEGER);
    }
    ...
    protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store,
        ...
        if (roleManager.isGM(playerRef)) {
            ...
            monster.stats.wisdom = value;

            Message primary = Message.raw(monster.getDisplayName() + " - Wisdom").color("#FFFFFF");
            Message secondary = Message.raw(CharacterStats.formatStatWithModifier(value)).color("#C0C0C0");
            ...
            state.stats.wisdom = value;

            Message primary = Message.raw("Wisdom").color("#FFFFFF");
            Message secondary = Message.raw(CharacterStats.formatStatWithModifier(value)).color("#C0C0C0");
            ItemWithAllMetadata icon = new ItemStack("Ingredient_Crystal_White", 1).toPacket();
