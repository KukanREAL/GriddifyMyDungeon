 ...
 */
public class INTCommand extends AbstractPlayerCommand {
    ...
    public INTCommand(GridMoveManager playerManager, RoleManager roleManager, EncounterManager encounterManager) {
        super("INT", "Set Intelligence stat");
        this.playerManager = playerManager;
        this.roleManager = roleManager;
        this.encounterManager = encounterManager;
        this.valueArg = this.withRequiredArg("value", "Intelligence value (0-30)", ArgTypes.INTEGER);
    }
    ...
    protected void execute(@Nonnull CommandContext context,
        ...
        if (roleManager.isGM(playerRef)) {
            ...
            monster.stats.intelligence = value;

            Message primary = Message.raw(monster.getDisplayName() + " - Intelligence").color("#0080FF");
            Message secondary = Message.raw(CharacterStats.formatStatWithModifier(value)).color("#FFFFFF");
            ItemWithAllMetadata icon = new ItemStack("Ingredient_Crystal_Blue", 1).toPacket();
            ...
            state.stats.intelligence = value;

            Message primary = Message.raw("Intelligence").color("#0080FF");
            Message secondary = Message.raw(CharacterStats.formatStatWithModifier(value)).color("#FFFFFF");
            ItemWithAllMetadata icon = new ItemStack("Ingredient_Crystal_Blue", 1).toPacket();
